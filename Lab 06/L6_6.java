...
class Tiger extends Animal{
    /*
        ...
        If we don't use super keyword then it will create object with default values of parent class attributes, but if we use super keyword then it will not create object with default values of parent class attributes and assign null or 0 to them.
    */
